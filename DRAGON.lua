...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/martenex/ROGEN/main/File_Bot/games.lua") 
...
os.execute('wget https://raw.githubusercontent.com/martenex/ROGEN/main/DRAGON.lua')
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/martenex/ROGEN/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/martenex/ROGEN/main/File_Bot/"..file)
if res == 200 then
