...
if [ ! $token ]; then
echo "┄─━━ʀᴏɢᴇɴ━━─┄ ┄─━━ʀᴏɢᴇɴ━━─┄ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE ma_Info.lua \e[0m"
echo "┄─━━ʀᴏɢᴇɴ━━─┄ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./ma_Info.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
